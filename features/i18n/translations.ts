...
export const translations: Record<Language, Record<string, string>> = {
  pl: {
    ...
    'grafik.add': 'Dodaj',
    'grafik.daysPlaceholder': 'Dni np. 3,7,15',
    'grafik.addDaysOff': 'Dodaj wychodne',
  ...
  uk: {
    ...
    'grafik.add': 'Додати',
    'grafik.daysPlaceholder': 'Дні напр. 3,7,15',
    'grafik.addDaysOff': 'Додати вихідні',
  ...
  ro: {
    ...
    'grafik.add': 'Adaugă',
    'grafik.daysPlaceholder': 'Zile ex. 3,7,15',
    'grafik.addDaysOff': 'Adaugă zile libere',
